  ...
  return (
    <section className="mt-10">
      ...
      <p className="text-center max-w-4xl mx-auto text-base sm:text-lg mt-8">
        Chez Travly, nous accordons une grande importance à la protection de vos
          ...
          <div className="border border-gray-300 p-6 rounded-lg flex flex-col sm:flex-row items-center space-y-4 sm:space-y-0 sm:space-x-6 md:rounded-none md:border-t-0 md:border-l-0 md:border-r-0 md:border-b">
            ...
            <div>
              ...
              <ul className="list-disc pl-5 mt-2 text-gray-700 space-y-1">
                <li>
                  Informations fournies par l'utilisateur : Nom, email,
                  préférences de recherche (destinations, dates, etc.).
                </li>
                <li>
                ...
                <li>
                  Données anonymisées : Statistiques d'utilisation du site pour
          ...
          <div className="border border-gray-300 p-6 rounded-lg flex flex-col sm:flex-row items-center space-y-4 sm:space-y-0 sm:space-x-6 md:rounded-none md:border-t-0 md:border-l-0 md:border-r-0 md:border-b">
            ...
            <div>
              ...
              <ul className="list-disc pl-5 mt-2 text-gray-700 space-y-1">
                ...
                <li>
                  Vous envoyer des notifications ou des emails, si vous y
                  consentez.
                </li>
              </ul>
            </div>
