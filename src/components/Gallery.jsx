        ...
        <div className="mt-5 px-4 grid grid-cols-1 sm:grid-cols-1 gap-4">
          ...
          <div className="flex gap-4">
            <div className="flex gap-2 items-center">
              <Icons iconName={iconEquipement1} />
              <p>{nomEqipement1}</p>
            </div>

            <div className="flex gap-2 items-center">
              <Icons iconName={iconEquipement2} />
              <p>{nomEqipement2}</p>
            </div>

            <div className="flex gap-2 items-center">
              <Icons iconName={iconEquipement3} />
              <p>{nomEqipement3}</p>
            </div>
            <div className="flex gap-2 items-center">
              <Icons iconName={iconEquipement4} />
              <p>{nomEqipement4}</p>
            </div>
          </div>
        </div>
            ...
            {lightBox && (
              <div className={lightBoxClass}>
                <div onClick={() => closeLightBox()}>
                  <Icons iconName={"xmark"} iconClass={IconCross} />
                </div>

                <div onClick={() => nextImg()}>
                  <Icons iconName={"arrowright"} iconClass={iconRight} />
                </div>

                <img
                  className={lighthBoxImg}
                  src={currentImg}
                  alt=""
                  id="lightBoxImg"
                />
                ...
                <div onClick={() => prevImg()}>
                  <Icons iconName={"arrowleft"} iconClass={iconLeft} />
                </div>
              </div>
            )}
          </div>
