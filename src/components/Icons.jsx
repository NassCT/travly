...
const HeartEmptyIcon = ({ iconClass, iconSize, onClick }) => (
  <svg className={iconClass} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width={`${iconSize || "20px"}`} onClick={onClick} style={{ cursor: "pointer" }}>
    <path
...
const PlaneIcon = ({ iconClass, iconSize }) => (
  <svg className={iconClass} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" width={`${iconSize || "20px"}`} fill="currentColor">
    <path
...
function Icons({ iconName, iconClass, iconSize, onClick }) {
  const icons = {
    ...
    heartempty: <HeartEmptyIcon iconClass={iconClass} iconSize={iconSize} onClick={onClick} />,
    heart: <HeartIcon iconClass={iconClass} iconSize={iconSize} onClick={onClick} />,
