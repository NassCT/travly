...
const GymIcon = ({ iconClass, iconSize }) => (
  <svg
    ...
    width={`${iconSize || "20px"}`}
  >
    <path d="M104 96C90.7 96 80 106.7 80 120V392C80 405.3 90.7 416 104 416C117.3 416 128 405.3 128 392V120C128 106.7 117.3 96 104 96zM536 96C522.7 96 512 106.7 512 120V392C512 405.3 522.7 416 536 416C549.3 416 560 405.3 560 392V120C560 106.7 549.3 96 536 96zM432 240H208V272H432V240zM360 384C373.3 384 384 373.3 384 360V152C384 138.7 373.3 128 360 128C346.7 128 336 138.7 336 152V360C336 373.3 346.7 384 360 384zM280 384C293.3 384 304 373.3 304 360V152C304 138.7 293.3 128 280 128C266.7 128 256 138.7 256 152V360C256 373.3 266.7 384 280 384z" />
  </svg>
);

const HeartEmptyIcon = ({ iconClass, iconSize, onClick }) => (
  <svg
    className={iconClass}
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 512 512"
...
const HeartIcon = ({ iconClass, iconSize, onClick }) => (
  <svg
    className={iconClass}
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 512 512"
...
function Icons({ iconName, iconClass, iconSize }) {
  const icons = {
    ...
    arrowrightleft: (
      <ArrowRightLeftIcon iconClass={iconClass} iconSize={iconSize} />
    ),
    ...
    planearrival: (
      <PlaneArrivalIcon iconClass={iconClass} iconSize={iconSize} />
    ),
    planedeparture: (
      <PlaneDepartureIcon iconClass={iconClass} iconSize={iconSize} />
    ),
