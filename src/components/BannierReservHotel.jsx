      ...
      <div className={classBannier}>
        ...
        <div className={classBannierContent}>
          <p className="text-sm md:text-base mb-6">
            Nous avons soigneusement sélectionné pour vous les offres d'hôtels
            les plus intéressantes. Trouvez la chambre parfaite à un prix encore
            plus avantageux.
            <br />
            Offrez-vous un séjour agréable à des prix compétitifs, pour une
            expérience de voyage à la fois confortable et abordable.
          </p>
        </div>
      </div>
    </section>
