    ...
    <section className="mt-10">
      ...
      <div className="px-10 lg:px-20 mx-auto max-w-4xl">
        <section className="py-10">
          ...
          <p>
            Les services sont exclusivement destinés à un usage personnel et non
            commercial. Toute utilisation illégale ou abusive, telle que la
            transmission de contenu offensant ou l'accès non autorisé, est
